...
export interface ApiAsisstantFormSubmissionAsisstantFormSubmission
  extends Schema.CollectionType {
  collectionName: 'asisstant_form_submissions';
  info: {
    singularName: 'asisstant-form-submission';
    pluralName: 'asisstant-form-submissions';
    displayName: 'Asisstant form submission';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
      'api::asisstant-form-submission.asisstant-form-submission',
      'oneToOne',
      'admin::user'
    > &
      Attribute.Private;
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::asisstant-form-submission.asisstant-form-submission': ApiAsisstantFormSubmissionAsisstantFormSubmission;
